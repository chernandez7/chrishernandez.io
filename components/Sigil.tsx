  ...
  const densitySettings =
    density === "ultra-low"
      ? {
          ...
          // Layer flags — ultra-low: sacred text/axioms persist; numeric/symbolic geometry sheds first
          showHeptagon: false,
      ...
      : density === "low"
        ? {
            ...
            // Layer flags — low: sacred text stays fixed while geometry restores in steps
            showHeptagon: false,
            showOuterTicks: true,
            showInscription: true,
            showEnochian: true,
        ...
        : density === "base"
          ? {
              ...
              // Layer flags — base: sacred text remains stable through perf adaptation
              showHeptagon: false,
              showOuterTicks: true,
              showInscription: true,
              showEnochian: true,
